...
/**
 * 功能描述 : 获取输入公历日期的生肖、天干地支、农历年、农历月、农历日、公历节日、农历节日、24节气等数据
 *
 * @author zhaorui 2021-10-29 14:34
 */
public class LunarCalendarFestivalUtil {
    ...
    public String getLunarMonthDay() {
        ...
        String month = df.format(lunarMonthInt);
        String day = df.format(lunarDayInt);
        return month + day;
    }

    public static LunarCalendarFestivalUtil initToday(String dateStr) {
        LunarCalendarFestivalUtil festival = new LunarCalendarFestivalUtil();
        festival.initLunarCalendarInfo(dateStr);
        return festival;
    }

    public static LunarCalendarFestivalUtil initToday() {
        LunarCalendarFestivalUtil festival = new LunarCalendarFestivalUtil();
        festival.initLunarCalendarInfo(DateUtil.formatDate(new Date()));
        return festival;
    }
}
